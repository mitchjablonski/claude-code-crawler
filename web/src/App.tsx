...
import { PhaseStub } from './screens/PhaseStub.js';
...
export function App({
  ...
  return (
    <div style={ui.page}>
      <HudStrip state={state} characterName={characterName} />
      {deckOpen && state.phase === 'map' ? (
        ...
        <PhaseStub state={state} content={content} onQuit={quitToTitle} />
      )}
    </div>
  );
}
